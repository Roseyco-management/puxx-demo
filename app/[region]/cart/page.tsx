                    ...
                    <div className="flex justify-between items-start mb-3">
                      <div>
                        <h3 className="font-heading text-lg mb-1">
                          <Link
                            href={`/${region}/products/${item.product.slug}`}
          ...
          <div className="lg:col-span-1">
            <div className="sticky top-24 bg-white rounded-xl border-2 shadow-lg p-6">
              ...
              <div className="space-y-4 mb-6">
                ...
                {!useCartStore.getState().isFreeShipping() && shipping > 0 && (
                  <div className="bg-muted/50 rounded-lg p-3 text-sm">
                    <p className="text-muted-foreground">
                      Add <span className="font-bold text-foreground">{config.currencySymbol}{(150 - subtotal).toFixed(2)}</span> more for FREE shipping!
                    </p>
                  </div>
                )}
              ...
              <Button asChild size="lg" className="w-full gradient-emerald mb-4">
                <Link href={`/${region}/checkout`}>
                  Proceed to Checkout
                </Link>
              </Button>

              <div className="text-xs text-center text-muted-foreground">
                Secure checkout powered by {config.paymentMethod}
              </div>
            </div>
          </div>
        </div>
