                ...
                <div className="space-y-4 pt-6 border-t">
                  ...
                  <div className="grid sm:grid-cols-3 gap-4">
                    ...
                    <div>
                      ...
                      <Input id="county" placeholder="e.g., London" required />
                    </div>
                    <div>
                      <Label htmlFor="postcode">Postcode</Label>
                      <Input id="postcode" placeholder="Optional" />
                    </div>
                  </div>
                </div>
                    ...
                    <label className="flex items-center justify-between p-4 border-2 rounded-lg cursor-pointer hover:border-primary transition-colors">
                      ...
                      <span className="font-bold">
                        {shippingCost === 0 ? (
                          ...
                          `${config.currencySymbol}${shippingCost.toFixed(2)}`
                        )}
                      </span>
                    </label>
                    <label className="flex items-center justify-between p-4 border-2 rounded-lg cursor-pointer hover:border-primary transition-colors">
                      ...
                      <span className="font-bold">{config.currencySymbol}9.99</span>
                    </label>
                  </div>
                </div>
            ...
            <div className="sticky top-24 space-y-6">
              ...
              <div className="bg-white rounded-xl border-2 shadow-lg p-6">
                    ...
                    <div key={item.product.id} className="flex gap-3">
                      ...
                      <div className="flex-grow min-w-0">
                        ...
                        <p className="text-sm font-semibold mt-1">
                          {config.currencySymbol}{(config.basePrice * item.quantity).toFixed(2)}
                        </p>
                      </div>
                    </div>
                  ))}
                ...
                <div className="space-y-3 border-t pt-4">
                  <div className="flex justify-between text-sm">
                    ...
                    <span className="font-semibold">{config.currencySymbol}{subtotal.toFixed(2)}</span>
                  </div>
                  <div className="flex justify-between text-sm">
                  ...
                  <div className="flex justify-between text-lg font-bold border-t-2 pt-3">
                    <span>Total</span>
                    <span className="text-primary">{config.currencySymbol}{total.toFixed(2)}</span>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-muted/50 rounded-xl p-4 space-y-3">
                ...
                <div className="flex items-center gap-3 text-sm">
                  ...
                  <span className="text-muted-foreground">Free shipping over {config.currencySymbol}150</span>
                </div>
              </div>
            </div>
          </div>
